...
# TogAI Development Roadmap

## Overview

This development roadmap is derived from the AndroidManifest.xml configuration and outlines the feature set, capabilities, and development priorities for the TogAI AI assistant application. The roadmap is organized into functional domains based on the manifest declarations.
...
TogAI is a sophisticated on-device AI assistant with the following key characteristics:
...
**Service**: `com.togai.llamacpp.TogAIInferenceService`
...
**Service**: `com.togai.sd.StableDiffusionService`
...
**Activity**: `com.togai.MainActivity`

**Features**:
- Single task launch mode
- Deep linking support (`togai://stripe`)
...
**Activities**:
- `com.togai.text.RememberActivity` - "TogAI, remember this!"
- `com.togai.text.ChatActivity` - "Chat with TogAI"
...
**Activities**:
- `com.togai.tasker.infer.ActivityConfigNewInferTask` - "Create Infer Task"
- `com.togai.tasker.taskcompleteevent.ActivityConfigTaskCompleteEvent` - "Task Completed"
- `com.togai.tasker.infer.InferInBackgroundActivity` - "Infer in Background"
- `com.togai.tasker.infer.ActivityBackgroundWork`
...
**Service**: `com.togai.taskmgr.TaskMgrService`

**Receiver**: `com.togai.taskmgr.StopServiceReceiver`
...
**Service**: `com.togai.HeadlessJsService`
...
**Permissions**:
- `com.togai.DYNAMIC_RECEIVER_NOT_EXPORTED_PERMISSION` (signature level)
...
Based on manifest analysis, TogAI follows these privacy principles:
...
This roadmap provides a comprehensive development plan for TogAI based on the capabilities declared in AndroidManifest.xml. The application represents a sophisticated on-device AI assistant with:
...
**Maintainer**: TogAI Development Team
