...
((()))      # Three nodes, lineage chain (3-tree)
(()())      # Three nodes, two sibling branches (3-tree)
(((())))    # Four nodes lineage chain (4-tree)
((()()))    # Four nodes, nested structure (4-tree)
((())())    # Four nodes, mixed structure (4-tree)
(()()())    # Four nodes, three sibling branches (4-tree)
```
...
2. Possible partitions of 3:
   - `3` → one 3-tree: `(((())))`
   - `1(2)` → one 2-tree nest with two 1-trees: `((()()))`
...
# Output:
# n=1: 1 orbs: 1 trees: 0
# n=2: 1 orbs: 1 trees: 1
# n=3: 1 orbs: 2 trees: 2 -> lcm(2)=2
# n=4: 2 orbs: 4 trees: 2x3 -> lcm(2,3)=6 (4=2x2)
# n=5: 3 orbs: 9 trees: 3x4 -> lcm(2,3)=6 (9=3x3)
# n=6: 6 orbs: 20 trees: 2x3x5 -> lcm(2,3,5)=30 [6=2x3](20=2x2x5)
# n=7: 11 orbs: 48 trees: 2x5x6 -> lcm(2,3,5)=30 (48=2x2x2x2x3) |7x7=48+1|
# n=8: 23 orbs: 115 trees: 2x3x5x7 -> lcm(2,3,5,7)=210 (115=5x23) |11x11=115+2x3|
# n=9: 47 orbs: 286 trees: 3x5x7x8 -> lcm(2,3,5,7)=210 (286=2x11x13) {253=11x23}+{33=11x3} |17x17=286+3|
# n=10: 106 orbs: 719 trees: 5x7x8x9 -> lcm(2,3,5,7)=210 [106=2x53](719) {715=5x11x13}+{4=2x2} |2x19x19=719+3|
# n=11: 235 orbs: 1842 trees: 7x8x9x10 -> lcm(2,3,5,7)=210 [235=5x47](1842=2x3x307)
```
